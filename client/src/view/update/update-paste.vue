    ...
    <i-col span="12">
      <Card>
        ...
        <div class="update-paste-btn-con">
          <span class="paste-tip">Use the Tab key in the column, line using the enter key</span>
...
export default {
  ...
  methods: {
    ...
    handleShow () {
      if (!this.validated) {
        this.$Notice.error({
          title: 'Your content is not standard',
          desc: `You are the first${this.errorIndex + 1}Rows of data is not standard, please amend`
        })
      } else {
